...
<div className="flex items-center justify-center w-full bg-gradient-custom bg-custom-radial relative">
    <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <h1 className="text-xl  md:text-3xl pb-3">Yasuhei Nakamura</h1>
        <p className="text-sm md:text-2xl max-w-md mb-4">Olá! Bem-vindo(a) ao meu portfólio! <br />
    Aqui você encontrará meus projetos mais recentes e as tecnologias que utilizo para criar soluções web eficazes. Explore os projetos e entre em contato para discutirmos como posso colaborar com você!
        ...
        <a href="src/assets/pdf" download="yasuheiFrontend.pdf" className="inline-block px-6 py-3 mt-2 lg:mt-0 border-2 border-indigo-500 text-indigo-500 hover:border-indigo-950 hover:opacity-95 hover:text-indigo-950 transition duration-300 ease-in-out sm:mt-4">
            Baixar Currículo
        </a>
    </div>
