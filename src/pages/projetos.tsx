...
export function Projetos() {
    ...
    return (
        <div id="projetos" className="pt-6 flex justify-center items-center w-full flex-col">
            <Title  title={title} />
            <div className="flex justify-center items-center w-full h-full gap-4 flex-wrap" >
                <CardProjetos
